...
import org.acumos.demo.logging.util.LoggingConstant;
...
public class LoggingController {
	...
	public String getInformation(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		LogConfig.setEnteringMDCs("first", "second","test",LoggingConstant.MDC_COMPLETED,LoggingConstant.MDC_DEBUG);
		...
		LogConfig.setEnteringMDCs("first", "second","test",LoggingConstant.MDC_COMPLETED,LoggingConstant.MDC_INFO);
